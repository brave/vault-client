...
function syncWorker() {
    ...
    function postMessage(data) {
        ...
        try {
            // this fires only once, so the cryptoOperation object never fires continueJob() with process/finish...
            if ((data.operationType == "encrypt") || (data.operationType == "decrypt")) {
              data.operationSubType = "process"
              msrcryptoWorker.jsCryptoRunner( { data: data });
              data.operationSubType = "finish"
            }
